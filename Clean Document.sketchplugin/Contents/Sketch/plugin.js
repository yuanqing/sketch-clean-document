...
/***/ "../../../../../../private/var/folders/3m/k48sh8d10bx5knjrzyvhpb8h0000gn/T/aacb1b7b-f889-424f-9696-933dde5e342a":
/*!*****************************************************************************************************!*\
  !*** /private/var/folders/3m/k48sh8d10bx5knjrzyvhpb8h0000gn/T/aacb1b7b-f889-424f-9696-933dde5e342a ***!
  \*****************************************************************************************************/
...
module.exports={'clean-document':__webpack_require__(/*! ./src/clean-document */ "./src/clean-document.js").default,'clean-layers/clean-layers':__webpack_require__(/*! ./src/clean-layers/clean-layers */ "./src/clean-layers/clean-layers.js").default,'clean-symbols/clean-symbols':__webpack_require__(/*! ./src/clean-symbols/clean-symbols */ "./src/clean-symbols/clean-symbols.js").default,'clean-styles/clean-styles':__webpack_require__(/*! ./src/clean-styles/clean-styles */ "./src/clean-styles/clean-styles.js").default,'clean-pages/clean-pages':__webpack_require__(/*! ./src/clean-pages/clean-pages */ "./src/clean-pages/clean-pages.js").default,'settings/settings':__webpack_require__(/*! ./src/settings/settings */ "./src/settings/settings.js").default,'settings/reset-settings':__webpack_require__(/*! ./src/settings/reset-settings */ "./src/settings/reset-settings.js").default}

/***/ }),

/***/ "../../node_modules/is-promise/index.js":
/*!***********************************************************************!*\
  !*** /Users/yuanqing/Desktop/sketch/node_modules/is-promise/index.js ***!
  \***********************************************************************/
/*! no static exports found */
...
/*!*********************************************************************************!*\
  !*** /Users/yuanqing/Desktop/sketch/node_modules/natural-compare-lite/index.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/*!**************************************************************************!*\
  !*** /Users/yuanqing/Desktop/sketch/node_modules/p-each-series/index.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var p_each_series__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! p-each-series */ "../../node_modules/p-each-series/index.js");
...
function getPluginDirectoryPath() {
  const pluginName = "Clean Document";
...
/***/ "../sketch-sort-layer-list/src/attributes/name.js":
/*!********************************************************!*\
  !*** ../sketch-sort-layer-list/src/attributes/name.js ***!
  \********************************************************/
/*! exports provided: default, sortByName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function sortByName(layers) {
  return layers.sort(function (a, b) {
    const aName = a.name.toLowerCase();
    const bName = b.name.toLowerCase();

    if (aName === bName) {
      return natural_compare_lite__WEBPACK_IMPORTED_MODULE_0___default()(a.id, b.id);
    }

    return natural_compare_lite__WEBPACK_IMPORTED_MODULE_0___default()(aName, bName);
  });
}
...
function smartSort([firstLayer, ...layers]) {
  ...
  layers.forEach(function (layer) {
    ...
    while (i-- > 0) {
      ...
      if (checkIfLayersOverlap(layer, resultLayer) || Object(_compare_y_and_x_position__WEBPACK_IMPORTED_MODULE_0__["default"])(layer, resultLayer) > 0) {
...
/* harmony import */ var _clean_pages_clean_pages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./clean-pages/clean-pages */ "./src/clean-pages/clean-pages.js");
/* harmony import */ var _clean_styles_clean_styles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./clean-styles/clean-styles */ "./src/clean-styles/clean-styles.js");
/* harmony import */ var _clean_symbols_clean_symbols__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./clean-symbols/clean-symbols */ "./src/clean-symbols/clean-symbols.js");
...
function cleanDocument() {
  ...
  Object(_clean_symbols_clean_symbols__WEBPACK_IMPORTED_MODULE_4__["default"])({
    isCleanDocument: true
  });
  Object(_clean_styles_clean_styles__WEBPACK_IMPORTED_MODULE_3__["default"])({
    isCleanDocument: true
  });
  Object(_clean_pages_clean_pages__WEBPACK_IMPORTED_MODULE_2__["default"])({
    isCleanDocument: true
  });
...
/* harmony import */ var sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sketch-plugin-helper */ "../sketch-plugin-helper/src/api.js");
/* harmony import */ var _settings_check_settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../settings/check-settings */ "./src/settings/check-settings.js");
/* harmony import */ var _delete_hidden_layer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./delete-hidden-layer */ "./src/clean-layers/delete-hidden-layer.js");
/* harmony import */ var _unnest_nested_group__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./unnest-nested-group */ "./src/clean-layers/unnest-nested-group.js");
/* harmony import */ var _round_to_nearest_pixel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./round-to-nearest-pixel */ "./src/clean-layers/round-to-nearest-pixel.js");
/* harmony import */ var _smart_rename_layer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./smart-rename-layer */ "./src/clean-layers/smart-rename-layer.js");
/* harmony import */ var _smart_sort_layer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./smart-sort-layer */ "./src/clean-layers/smart-sort-layer.js");
...
function cleanLayers({
  ...
  const settings = Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__["getSettings"])().cleanLayers;

  if (!Object(_settings_check_settings__WEBPACK_IMPORTED_MODULE_1__["default"])(settings)) {
    return;
  }
  ...
  Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__["iterateNestedLayers"])(layers, function (layer) {
    ...
    if (settings.deleteHiddenLayers && Object(_delete_hidden_layer__WEBPACK_IMPORTED_MODULE_2__["default"])(layer)) {
      return;
    }
    ...
    if (settings.roundToNearestPixel) {
      console.log('2');
      Object(_round_to_nearest_pixel__WEBPACK_IMPORTED_MODULE_4__["default"])(layer);
    }

    if (settings.smartRenameLayers) {
      Object(_smart_rename_layer__WEBPACK_IMPORTED_MODULE_5__["default"])(layer);
    }

    if (settings.smartSortLayers) {
      Object(_smart_sort_layer__WEBPACK_IMPORTED_MODULE_6__["default"])(layer);
    }

    if (settings.unnestNestedGroups) {
      Object(_unnest_nested_group__WEBPACK_IMPORTED_MODULE_3__["default"])(layer);
    }
  });
...
/***/ "./src/clean-layers/round-to-nearest-pixel.js":
/*!****************************************************!*\
  !*** ./src/clean-layers/round-to-nearest-pixel.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return roundToNearestPixel; });
const keys = ['width', 'height', 'x', 'y'];
function roundToNearestPixel(layer) {
...
function smartSortLayer(layer) {
  if (layer.type === 'Artboard' || layer.type === 'Group') {
    ...
    const sortedLayers = Object(sketch_sort_layer_list_src_attributes_smart_sort__WEBPACK_IMPORTED_MODULE_0__["smartSort"])(layers);
...
/***/ "./src/clean-pages/clean-pages.js":
/*!****************************************!*\
  !*** ./src/clean-pages/clean-pages.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return cleanPages; });
/* harmony import */ var natural_compare_lite__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! natural-compare-lite */ "../../node_modules/natural-compare-lite/index.js");
/* harmony import */ var natural_compare_lite__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(natural_compare_lite__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! sketch-plugin-helper */ "../sketch-plugin-helper/src/api.js");
/* harmony import */ var _settings_check_settings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../settings/check-settings */ "./src/settings/check-settings.js");
...
function cleanPages({
  ...
  const settings = Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_2__["getSettings"])().cleanPages;

  if (!Object(_settings_check_settings__WEBPACK_IMPORTED_MODULE_3__["default"])(settings)) {
    return;
  }
  ...
  if (!settings.deleteEmptyPages || count === 0) {
    Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_2__["showSuccessMessage"])('Sorted pages');
    return;
  }

  Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_2__["showSuccessMessage"])(`Sorted pages and deleted ${count} empty page${count === 1 ? '' : 's'}`);
}

function sortPages() {
  const document = Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_2__["getCurrentDocument"])().sketchObject;
  const pages = document.pages();
  const symbolsPage = Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_2__["getSymbolsPage"])();
  const symbolsPageId = symbolsPage ? symbolsPage.id : null;
  pages.sort(function (a, b) {
    const pageA = Object(sketch__WEBPACK_IMPORTED_MODULE_1__["fromNative"])(a);
    const pageB = Object(sketch__WEBPACK_IMPORTED_MODULE_1__["fromNative"])(b);
    ...
    if (pageA.name === pageB.name) {
      return natural_compare_lite__WEBPACK_IMPORTED_MODULE_0___default()(pageA.id, pageB.id);
    }

    return natural_compare_lite__WEBPACK_IMPORTED_MODULE_0___default()(pageA.name.toLowerCase(), pageB.name.toLowerCase());
  });
...
function deleteEmptyPages() {
  let count = 0;
  Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_2__["getAllPages"])().forEach(function (page) {
...
/***/ "./src/clean-styles/clean-styles.js":
/*!******************************************!*\
  !*** ./src/clean-styles/clean-styles.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return cleanStyles; });
/* harmony import */ var sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sketch-plugin-helper */ "../sketch-plugin-helper/src/api.js");
/* harmony import */ var _settings_check_settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../settings/check-settings */ "./src/settings/check-settings.js");
/* harmony import */ var _delete_unused_styles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./delete-unused-styles */ "./src/clean-styles/delete-unused-styles.js");
...
function cleanStyles({
  ...
  const settings = Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__["getSettings"])().cleanStyles;
  ...
  if (settings.deleteUnusedLayerStyles) {
    count += Object(_delete_unused_styles__WEBPACK_IMPORTED_MODULE_2__["deleteUnusedLayerStyles"])();
  }

  if (settings.deleteUnusedTextStyles) {
    count += Object(_delete_unused_styles__WEBPACK_IMPORTED_MODULE_2__["deleteUnusedTextStyles"])();
  }
  ...
  if (count === 0) {
    Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__["showMessage"])('No unused styles');
    return;
  }

  Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__["showSuccessMessage"])(`Deleted ${count} unused style${count === 1 ? '' : 's'}`);
}

/***/ }),

/***/ "./src/clean-styles/delete-unused-styles.js":
/*!**************************************************!*\
  !*** ./src/clean-styles/delete-unused-styles.js ***!
  \**************************************************/
...
/***/ "./src/clean-symbols/clean-symbols.js":
/*!********************************************!*\
  !*** ./src/clean-symbols/clean-symbols.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return cleanSymbols; });
/* harmony import */ var sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sketch-plugin-helper */ "../sketch-plugin-helper/src/api.js");
/* harmony import */ var _settings_check_settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../settings/check-settings */ "./src/settings/check-settings.js");
/* harmony import */ var _delete_unused_symbols__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./delete-unused-symbols */ "./src/clean-symbols/delete-unused-symbols.js");
/* harmony import */ var _organise_symbols__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./organise-symbols */ "./src/clean-symbols/organise-symbols.js");
...
function cleanSymbols({
  ...
  const settings = Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__["getSettings"])().cleanSymbols;
  ...
  if (settings.deleteUnusedSymbols) {
    count = Object(_delete_unused_symbols__WEBPACK_IMPORTED_MODULE_2__["default"])();
  }

  if (settings.organiseSymbols) {
    Object(_organise_symbols__WEBPACK_IMPORTED_MODULE_3__["default"])({
  ...
  if (settings.deleteUnusedSymbols) {
    ...
    if (count !== 0) {
      ...
      cleanSymbols({
        isCleanDocument,
        totalDeletedSymbolsCount
      });
      return;
    }

    if (totalDeletedSymbolsCount === 0) {
      Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__["showMessage"])('No unused symbols');
      return;
    }

    Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__["showSuccessMessage"])(`Deleted ${totalDeletedSymbolsCount} unused symbol${totalDeletedSymbolsCount === 1 ? '' : 's'}`);
  }
}

/***/ }),

/***/ "./src/clean-symbols/delete-unused-symbols.js":
/*!****************************************************!*\
  !*** ./src/clean-symbols/delete-unused-symbols.js ***!
  \****************************************************/
/*! exports provided: default */
...
/***/ "./src/clean-symbols/organise-symbols.js":
/*!***********************************************!*\
  !*** ./src/clean-symbols/organise-symbols.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return organiseSymbols; });
/* harmony import */ var natural_compare_lite__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! natural-compare-lite */ "../../node_modules/natural-compare-lite/index.js");
/* harmony import */ var natural_compare_lite__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(natural_compare_lite__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! sketch-plugin-helper */ "../sketch-plugin-helper/src/api.js");
/* harmony import */ var sketch_sort_layer_list_src_attributes_name__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! sketch-sort-layer-list/src/attributes/name */ "../sketch-sort-layer-list/src/attributes/name.js");
/* harmony import */ var sketch_sort_layer_list_src_update_layer_list__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! sketch-sort-layer-list/src/update-layer-list */ "../sketch-sort-layer-list/src/update-layer-list.js");





function organiseSymbols({
  groupDefinition,
  space
}) {
  ...
  const symbolsPage = Object(sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_2__["getSymbolsPage"])() || sketch_dom__WEBPACK_IMPORTED_MODULE_1__["Page"].createSymbolsPage();
...
const slashRegularExpression = /\s*\/\s*/;
...
function createSymbolGroups({
  ...
  const groups = {};
  symbols.forEach(function (layer) {
    const split = layer.name.split(slashRegularExpression);
  ...
  return Object.values(groups).sort(function (a, b) {
    return natural_compare_lite__WEBPACK_IMPORTED_MODULE_0___default()(a.groupName.toLowerCase(), b.groupName.toLowerCase());
  }).map(function ({
    layers
  }) {
    return Object(sketch_sort_layer_list_src_attributes_name__WEBPACK_IMPORTED_MODULE_3__["sortByName"])(layers);
  });
}

function arrangeSymbolGroups({
  symbolGroups,
  space
}) {
  let x = 0;
...
function sortLayerList(symbolGroups) {
  ...
  Object(sketch_sort_layer_list_src_update_layer_list__WEBPACK_IMPORTED_MODULE_4__["default"])({
    sortedLayers: layers,
    shouldSelectLayers: false
  });
}
...
/***/ "./src/settings/check-settings.js":
/*!****************************************!*\
  !*** ./src/settings/check-settings.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return checkSettings; });
...
const settingsConfig = {
  ...
  inputs: [{
    ...
    type: sketch_plugin_helper__WEBPACK_IMPORTED_MODULE_0__["NUMERIC_TEXT_BOX"],
...
/***/ 0:
/*!***********************************************************************************************************!*\
  !*** multi /private/var/folders/3m/k48sh8d10bx5knjrzyvhpb8h0000gn/T/aacb1b7b-f889-424f-9696-933dde5e342a ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /private/var/folders/3m/k48sh8d10bx5knjrzyvhpb8h0000gn/T/aacb1b7b-f889-424f-9696-933dde5e342a */"../../../../../../private/var/folders/3m/k48sh8d10bx5knjrzyvhpb8h0000gn/T/aacb1b7b-f889-424f-9696-933dde5e342a");
